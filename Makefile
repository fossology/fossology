...
CFLAGS=-g -Wall $(BASEFLAGS)  #-DPHRASE_DEBUG  -DDOCTOR_DEBUG -DLTSR_DEBUG -DUNPACK_DEBUG -DPHRASE_DEBUG -DUNKNOWN_CHECK_DEBUG -DLICENSE_DEBUG -DPACKAGE_DEBUG -DSTOPWATCH -DPARSE_STOPWATCH -DREPORT_DEBUG -DBUCKET_DEBUG -DMEMSTATS -O0 
