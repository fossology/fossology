...
class ui_menu extends Plugin
  ...
  /********************************************
   OutputDetail(): Create the output.
   ********************************************/
  function OutputDetail()
	...
	if ($Depth < $MenuMaxDepth)
	  ...
	  $Label = "ul#nav-" . $Depth;
	  $V .= $Label . "\n";
	  $V .= "  { margin:0; padding:1px 0; list-style:none; width:100%; height:24px; font:normal 10pt verdana, arial, helvetica;}\n";
	  $Label .= " li";
	  $V .= $Label . "\n";
	...
	if ($Depth < $MenuMaxDepth)
	  ...
	  $V .= "  { margin:0; padding:1px 0; display:none; left:0px; width:150px; position:absolute; top:24px; }\n";
	...
	for( ; $Depth < $MenuMaxDepth; $Depth++)
	  {
	  $V .= "/* CSS for Depth $Depth */\n";
	  $V .= $Label . " ul.nav-" . $Depth . "\n";
	  $V .= "  { margin:0; padding:1px 0; display:none; left:" . 150*($Depth-1) . "px; width:150px; position:absolute; top:0px; }\n";
	  $V .= $Label . ":hover ul.nav-" . $Depth . "\n";
	  $V .= "  { display:block; }\n";
	  $Label .= " ul.nav-" . $Depth . " li";
	  $V .= $Label . "\n";
	  ...
	  $V .= "  { padding:4px 0; color:white; background:red; width:150px; display:block; }\n";
	  $V .= $Label . " a span\n";
	  $V .= "  { position:absolute; top:0; left:" . 150*($Depth-1)-15 . "px; font-size:12pt; color:white; }\n";
	  }
