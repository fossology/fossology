...
Type1SL List1SL[] = {
	...
	{"1SL: %s", "< %2 is|be distributed|redistributed|released|licensed|licenced|covered|adheres as|under|by|in|from %EOS >"},
	{"1SL: %s", "< %2 distributed|redistributed|released|licensed|licenced|covered|adheres as|under|by|in|from %EOS >"},
	{"1SL: %s", "< %2 provided under %EOS >"},
