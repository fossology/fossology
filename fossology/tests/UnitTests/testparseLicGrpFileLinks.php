...
require_once ('../testClasses/parseLicenseGrpTbl.php');
require_once ('../fossologyWebTestCase.php');
require_once ('../TestEnvironment.php');

global $URL;

class testParseLiceseTblGrp extends fossologyWebTestCase
{
  public $mybrowser;
  ...
  function testPLicenseTblGrp()
  {
     ...
     */
    $testPages = array (
    'http://snape.west/repo/?mod=licgroup&show=detail&upload=155&item=49948',
                        );
    /*
    ...
    foreach ($testPages as $link)
    {
      ...
      $LGtbl = new parseLicenseGrpTbl($page);
      $parsed = $LGtbl->parseLicenseGrpTbl();
