...
class cliPkgagentTest extends fossologyTestCase
{
  ...
  function testOneRpm()
  {
    ...
    $file = '/home/madong/fossology/tests/packageAgent/TestData/fossology-1.1.0-1.centos4.i386.rpm';
    // run the pkgagent with an rpm
    $cmd = "$AGENTDIR/pkgagent $file";
    print "running $cmd\n";
  ...
  function testOneRpmV()
  {
    ...
    // check the output
    if(empty($output)){
	$this->fail("pkgagent FAILED!, no output, stopping test");
	exit(1);
    }	
