...
define("TITLE_agent_foreport", _("Report generation"));

class agent_foreport extends FO_Plugin
{
  ...
  function __construct() {
    $this->Name = "agent_foreport";
    $this->Title = TITLE_agent_foreport;
    $this->Version = "1.0";
    $this->Dependency = array();
    $this->DBaccess = PLUGIN_DB_WRITE;
    $this->AgentName = "report";
  ...
  function Output()
  {
    ...
    $text = sprintf(_("Generating Report for '%s'"), $ShortName);
    return "<h2>".$text."</h2>";
  }
