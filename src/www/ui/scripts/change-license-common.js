...
function saveExpression() {
  if (currentAST != null) {
    $.getJSON("?mod=conclude-license&do=saveExpression" + "&upload=" + uploadId + "&item=" + $('#uploadTreeId').val() + "&ast=" + JSON.stringify(currentAST) + "&astId=" + currentASTId)
      .done(function (data) {
