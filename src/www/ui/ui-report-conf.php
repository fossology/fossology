...
class ui_report_conf extends FO_Plugin
{
  ...
  function allReportConfiguration($uploadId, $groupId)
  {
    ...
    $vars['cyclonedxSpecVersion'] = isset($cyclonedxSettings[4]) ? $cyclonedxSettings[4] : '1.7';
  ...
  public function Output()
  {
    ...
    if (isset($submitReportConf)) {
      ...
      $cyclonedxSpecVersion = GetParm('cyclonedxSpecVersion', PARM_STRING);
      if (!in_array($cyclonedxSpecVersion, $allowedVersions)) {
        $cyclonedxSpecVersion = '1.7';
      }
      $cyclonedxSettingsToSave .= ',' . $cyclonedxSpecVersion;
