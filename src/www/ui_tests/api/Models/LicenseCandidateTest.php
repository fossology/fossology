...
/*
 ...
 Author: Valens Niyonsenga <valensniyonsenga2003@gmail.com>
...
class LicenseCandidateTest extends \PHPUnit\Framework\TestCase
{
   ...
   */
  public function getLicenseCandidateInfo()
  {
    $id = 9;
    $shortname = "MIT";
    $spdxid = 2;
  ...
  /**
   * Test LicenseCandidate:getArray() with ApiVersion::V1
   * Tests the getArray method of the LicenseCandidate class with API version 1.
  ...
  public function testDataFormatV1()
  {
    ...
    $expectedArray = $this->getLicenseCandidateInfo()['v1'];
    $this->assertEquals($expectedArray, $obj->getArray(ApiVersion::V1));
  }

  /**
   * Test LicenseCandidate:getArray() with ApiVersion::V2
   * Tests the getArray method of the LicenseCandidate class with API version 2.
   *  - # Check if the returned array matches the expected data for version 2
   */
  public function testDataFormatV2()
  {
    $obj = $this->getLicenseCandidateInfo()['obj'];
    $expectedArray = $this->getLicenseCandidateInfo()['v2'];
    $this->assertEquals($expectedArray, $obj->getArray(ApiVersion::V2));
  }
  ...
  {
    $data = $this->getLicenseCandidateInfo()['v1'];
    $data['rf_pk'] = 9;
    ...
    $expectedObj = $this->getLicenseCandidateInfo()['v1'];
