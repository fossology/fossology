...
/**
 * @dir
 * @brief Functional test cases for spdx3 agent
 * @file
 * @brief Functional test cases for spdx3 agent and scheduler interaction
 */
/**
 * @namespace Fossology::SpdxThree::Test
 * @brief Namespace to hold test cases for spdx3 agent
 */
namespace Fossology\SpdxThree\Test;
...
/**
 * @class SchedulerTest
 * @brief Tests for spdx3 agent and scheduler interaction
 */
class SchedulerTest extends \PHPUnit\Framework\TestCase
{
  ...
  {
    $this->testDb = new TestPgDb("spdx3test");
    $this->dbManager = $this->testDb->getDbManager();

    $this->runnerCli = new SchedulerTestRunnerCli($this->testDb);
    $this->assertCountBefore = \Hamcrest\MatcherAssert::getCount();

    $this->agentDir = dirname(__DIR__, 4) . '/build/src/spdx3';
  }
  ...
  /**
   * @brief Test spdx3 agent for RDF
   *
