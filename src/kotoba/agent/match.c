...
static char* getFileName(KotobaState* state, long pFileId) {
...
int processMatch(KotobaState* state, const File* file, const Match* match, const MatchCallbacks* callbacks) {
  const License* license = match->license;
