...
/* 1 */ { "application/gzip","zcat","","> '%s' 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 2 */ { "application/x-gzip","zcat","","> '%s' 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 3 */ { "application/x-compress","zcat","","> '%s' 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 4 */ { "application/x-bzip","bzcat","","> '%s' 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 5 */ { "application/x-bzip2","bzcat","","> '%s' 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 6 */ { "application/x-upx","upx","-d -q -o'%s'"," 2>&1","",CMD_PACK,1,0177000,0177000, },
/* 7 */ { "application/pdf","pdftotext","-htmlmeta","'%s' 2>&1","",CMD_PACK,1,0100000,0100000, },
/* 8 */ { "application/x-pdf","pdftotext","-htmlmeta","'%s' 2>&1","",CMD_PACK,1,0100000,0100000, },
/* 9 */ { "application/x-zip","unzip","-q -P none -o","-x / 2>&1","unzip -Zhzv '%s' > '%s'",CMD_ARC,1,0177000,0177000, },
/* 10 */{ "application/zip","unzip","-q -P none -o","-x / 2>&1","unzip -Zhzv '%s' > '%s'",CMD_ARC,1,0177000,0177000, },
/* 11 */{ "application/x-tar","tar","-xSf","2>&1 ","",CMD_ARC,1,0177000,0177777, },
/* 12 */{ "application/x-gtar","tar","-xSf","2>&1 ","",CMD_ARC,1,0177000,0177777, },
/* 13 */{ "application/x-cpio","cpio","--no-absolute-filenames --quiet -i -d <","2>&1","",CMD_ARC,1,0177777,0177777, },
/* 14 */{ "application/x-rar","unrar","x -o+ -p-","2>&1","",CMD_ARC,1,0177000,0177000, },
/* 15 */{ "application/x-cab","cabextract","-q","2>&1","",CMD_ARC,1,0177000,0177000, },
/* 16 */{ "application/x-7z-compressed","7z","x -y -pjunk","2>&1","",CMD_ARC,1,0177000,0177000, },
/* 17 */{ "application/x-7z-w-compressed","7z","x -y -pjunk","2>&1","",CMD_ARC,1,0177000,0177000, },
...
/* 27 */{ "application/x-x86_boot","departition","","2>&1","",CMD_PARTITION,1,0177000,0177000, },
/* 28 */{ "application/x-debian-source","dpkg-source","-x","'%s' >/dev/null 2>&1","",CMD_DEB,1,0177000,0177000, },
/* 29 */{ "application/x-xz","tar","-JxSf","2>&1","",CMD_ARC,1,0177000,0177777, },
/* 30 */{ "application/jar","unzip","-q -P none -o","-x / 2>&1","unzip -Zhzv '%s' > '%s'",CMD_ARC,1,0177000,0177000, },
/* 31 */{ "application/java-archive","unzip","-q -P none -o","-x / 2>&1","unzip -Zhzv '%s' > '%s'",CMD_ARC,1,0177000,0177000, },
/* 32 */{ "application/x-dosexec","7z","x -y -pjunk",">2>&1","",CMD_ARC,1,0177000,0177000, },
/* 33 */{ "application/vnd.openxmlformats-officedocument.presentationml.presentation","unzip","-q -P none -o","-x / 2>&1","unzip -Zhzv '%s' > '%s'",CMD_ARC,1,0177000,0177000, },
