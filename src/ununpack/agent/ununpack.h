...
extern inline int  Prune (char *Fname, struct stat Stat);
extern inline int	MkDirs	(char *Fname);
extern inline int	MkDir	(char *Fname);
extern inline int	IsDir	(char *Fname);
extern inline int	RemoveDir	(char *dirpath);
