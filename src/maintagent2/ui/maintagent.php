...
define("TITLE_MAINTAGENT2", _("FOSSology Maintenance (v2)"));
 ...
 */
class maintagent2 extends FO_Plugin {
  ...
  {
    $this->Name = "maintagent2";
    $this->Title = TITLE_MAINTAGENT2;
