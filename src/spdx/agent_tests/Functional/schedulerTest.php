...
/**
 * @dir
 * @brief Functional test cases for spdx agent
 * @file
 * @brief Functional test cases for spdx agent and scheduler interaction
 */
/**
 * @namespace Fossology::Spdx::Test
 * @brief Namespace to hold test cases for spdx agent
 */
namespace Fossology\Spdx\Test;
...
/**
 * @class SchedulerTest
 * @brief Tests for Spdx agent and scheduler interaction
 */
class SchedulerTest extends \PHPUnit\Framework\TestCase
{
  ...
  {
    $this->testDb = new TestPgDb("spdxtest");
