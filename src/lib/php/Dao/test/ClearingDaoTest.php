...
class ClearingDaoTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function setUp()
  {
    ...
    $this->dbManager->prepare($stmt = 'insert.cd',
        "INSERT INTO license_decision_event (license_decision_event_pk, pfile_fk, uploadtree_fk, user_fk, rf_fk, is_removed, is_global, type_fk, date_added) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)");
    $cdArray = array(
        ...
        array(4, 100, 1200, 2, 3, false, true, 2, '2014-08-15T10:43:58'),
