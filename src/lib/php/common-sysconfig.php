...
function Populate_sysconfig()
{
  ...
  $variable = "OidcM2MResourceOwnerURL";
  $oidcPrompt = _('OIDC M2M User Info URL(required for provider initialisation)');
  $oidcDesc = _('e.g. "http://oauth.com/userinfo.oauth2"<br>URL for M2M OAuth2 user info endpoint.');
  $valueArray[$variable] = array("'$variable'", "null", "'$oidcPrompt'",
    strval(CONFIG_TYPE_TEXT), "'OauthM2M'", "6", "'$oidcDesc'", "null", "null");
