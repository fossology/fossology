...
function Populate_sysconfig()
{
  ...
  $valueArray[$variable] = array("'$variable'", "null", "'$FossologyInstanceNamePrompt'",
    strval(CONFIG_TYPE_TEXT), "'FossDashAPI'", "3", "'$FossologyInstanceNameDesc'", "'$instanceNameValid'", "null");
  ...
  $valueArray[$variable] = array("'$variable'", "'0'", "'$AuthTypePrompt'",
    strval(CONFIG_TYPE_DROP), "'FossDashAPI'", "6", "'$AuthTypeDesc'", "null", "'Token_based{0}|Uname_pass{1}'");
  ...
  $valueArray[$variable] = array("'$variable'", "'fossy'", "'$InfluxDBUserPrompt'",
    strval(CONFIG_TYPE_TEXT), "'FossDashAPI'", "7", "'$InfluxDBUserDesc'", "'$InfluxDBUserValid'", "null");
  ...
  $valueArray[$variable] = array("'$variable'", "'fossy'", "'$InfluxDBUserPasswordPrompt'",
    strval(CONFIG_TYPE_PASSWORD), "'FossDashAPI'", "8", "'$InfluxDBUserPasswordDesc'", "'$InfluxDBUserPasswordValid'", "null");
  ...
  $valueArray[$variable] = array("'$variable'", "null", "'$InfluxDBTokenPrompt'",
    strval(CONFIG_TYPE_TEXTAREA), "'FossDashAPI'", "9", "'$InfluxDBTokenDesc'", "null", "null");
