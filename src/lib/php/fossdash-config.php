...
function Populate_fossdashconfig()
{
  ...
  $FossologyInstanceNamePrompt = _('Fossology instance name');
  ...
  $FossologyInstanceNameDesc = _('Set the fossology instance name, leave empty to use autogenerated UUID value.
                                  <br>e.g. Instance name format = <b>[a-zA-Z0-9_-]+ </b>.');
  ...
  $InfluxDBUserPasswordPrompt = _('InfluxDB Password');
  $InfluxDBUserPasswordValid = "check_password";
  $InfluxDBUserPasswordDesc = _('Set the password for Influx user. Password length must be at least 3');
